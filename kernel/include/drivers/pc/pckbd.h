...
struct pckbd_driver {
  ...
  pckbd_scancode_set_t *pckbd_sc_capslock; // Scancode characters modified by capslock
  pckbd_scancode_set_t *pckbd_sc_shift_capslock; // Scancode characters modified by shift & capslock
